...
# =============================================================================
# Gemma2TroughModel — inner model with pre-allocated trough buffer
# =============================================================================


class _Gemma2TroughModelImpl(Gemma2Model):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
...
@support_torch_compile
class Gemma2TroughModel(_Gemma2TroughModelImpl):
    pass
...
class Gemma2ForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        if self.enable_trough_decoding:
            logger.info(
                "Gemma2 trough decoding init: enabled=%s, "
    ...
    def forward(
        ...
        is_trough_model = isinstance(self.model, Gemma2TroughModel)
    ...
    def compute_logits(
        ...
        assert isinstance(self.model, Gemma2TroughModel)
