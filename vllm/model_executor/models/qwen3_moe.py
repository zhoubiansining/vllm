...
# =============================================================================
# Qwen3MoeTroughModel — inner model with pre-allocated trough buffer
# =============================================================================


class _Qwen3MoeTroughModelImpl(Qwen3MoeModel):
...
@support_torch_compile
class Qwen3MoeTroughModel(_Qwen3MoeTroughModelImpl):
    pass
...
class Qwen3MoeForCausalLM(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        if self.enable_trough_decoding:
            self.model = Qwen3MoeTroughModel(
        ...
        if self.enable_trough_decoding:
            logger.info(
                "Qwen3MoE trough decoding init: enabled=%s, "
    ...
    def forward(
        ...
        is_trough_model = isinstance(self.model, Qwen3MoeTroughModel)
    ...
    def compute_logits(
        ...
        assert isinstance(self.model, Qwen3MoeTroughModel)
