...
# =============================================================================
# Gemma4TroughModel — inner model with pre-allocated trough buffer
# =============================================================================


class _Gemma4TroughModelImpl(Gemma4Model):
    ...
    def forward(
        ...
        **kwargs,
        ...
        for layer_idx, layer in enumerate(
            ...
            if (self.start_layer + layer_idx) >= self._trough_start_layer:
...
class Gemma4TroughModel(_Gemma4TroughModelImpl, EagleModelMixin):
    pass


class Gemma4ForCausalLM(
    nn.Module, HasInnerState, SupportsLoRA, SupportsPP, MixtureOfExperts,
    SupportsEagle3,
):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        if self.enable_trough_decoding:
            logger.info(
                "Gemma4 trough decoding init: enabled=%s, "
    ...
    def forward(
        ...
        **kwargs,
        ...
        is_trough_model = isinstance(self.model, Gemma4TroughModel)
    ...
    def compute_logits(
        ...
        assert isinstance(self.model, Gemma4TroughModel)
