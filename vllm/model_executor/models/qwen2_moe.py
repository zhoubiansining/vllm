...
# =============================================================================
# Qwen2MoeTroughModel — inner model with pre-allocated trough buffer
# =============================================================================


class _Qwen2MoeTroughModelImpl(Qwen2MoeModel):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
...
@support_torch_compile
class Qwen2MoeTroughModel(_Qwen2MoeTroughModelImpl):
    pass
...
class Qwen2MoeForCausalLM(nn.Module, SupportsPP, SupportsLoRA):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        if self.enable_trough_decoding:
            self.model = Qwen2MoeTroughModel(
        ...
        if self.enable_trough_decoding:
            logger.info(
                "Qwen2MoE trough decoding init: enabled=%s, "
    ...
    def forward(
        ...
        is_trough_model = isinstance(self.model, Qwen2MoeTroughModel)
    ...
    def compute_logits(
        ...
        assert isinstance(self.model, Qwen2MoeTroughModel)
