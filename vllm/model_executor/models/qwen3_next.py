...
# =============================================================================
# Qwen3NextTroughModel — inner model with pre-allocated trough buffer
# =============================================================================


class _Qwen3NextTroughModelImpl(Qwen3NextModel):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
...
@support_torch_compile
class Qwen3NextTroughModel(_Qwen3NextTroughModelImpl):
    pass
...
class Qwen3NextForCausalLM(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        if self.enable_trough_decoding:
            self.model = Qwen3NextTroughModel(
        ...
        if self.enable_trough_decoding:
            logger.info(
                "Qwen3Next trough decoding init: enabled=%s, "
    ...
    def forward(
        ...
        **kwargs: object,
        ...
        is_trough_model = isinstance(self.model, Qwen3NextTroughModel)
    ...
    def compute_logits(
        ...
        assert isinstance(self.model, Qwen3NextTroughModel)
